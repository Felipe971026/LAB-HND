...
import { FileText, Download, User, Calendar, Droplets, Eye, Trash2, Edit2 } from 'lucide-react';
...
export const RecordCard: React.FC<RecordCardProps> = ({ record, onView, onDelete, onEdit, currentUserUid, isAdmin, isUsed }) => {
  const canDelete = currentUserUid === record.uid || isAdmin;
