...
import { Package, Calendar, Droplets, CheckCircle, XCircle, Trash2, User, Eye, X, Thermometer, Info, ClipboardCheck, UserCheck, Edit2 } from 'lucide-react';
...
export const RecepcionRecordCard: React.FC<RecepcionRecordCardProps> = ({ record, isUsed, onDelete, onEdit, currentUserUid, isAdmin }) => {
